...
<form action="">
<p>
';hidden_fields_get();echo($i?html_select("db",array(""=>"(".'database'.")")+$i,DB,"this.form.submit();"):'<textarea name="db" style="width:240px;height:40px">'.h(DB).'</textarea>'),'<br /><input type="submit" value="Use"',($i?" class='hidden'":""),' onclick="eventStop(event);">
